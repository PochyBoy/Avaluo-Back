      ...
      */
      ...
      export const getUsuario = async (req, res) => {
        try {
          ...
          const result = await pool.request().query(querys.getAllbanca);
      ...
      export const createNewbanca = async (req, res) => {
      ...
      export const getbancaById = async (req, res) => {
        try {
          const pool = await getConnection();

          const result = await pool
            .request()
            .input("id_banca", req.params.id_banca)
            .query(querys.getbancaById);
      ...
      export const deletebancaById = async (req, res) => {
        try {
          const pool = await getConnection();
      ...
      export const getTotalbanca = async (req, res) => {
        /*const pool = await getConnection();

        const result = await pool.request().query(querys.getTotalbanca);
        console.log(result);
        res.json(result.recordset[0][""]);
      */};

      export const updatebancaById = async (req, res) => {
